...
class TrackingArray ():
	...
	def assign (self, out_file, frame_start = 0, frame_end = -1):
		...
		with open(out_file, 'w') as outfile:
			csv_writer = csv.DictWriter(outfile, fieldnames = ['Origin interactor', 'Destination interactor', 'Interaction Name', 'Interaction Frame'], delimiter = '\t')
	...
	@staticmethod
	def processInteractionsFile (interactions_file, frame_start, frame_end, limit_interactions = [], expected_cols = ['Origin interactor', 'Destination interactor', 'Interaction Name', 'Interaction Frame']):
