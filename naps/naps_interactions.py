...
def interactionParser ():
	...
	# Input files
	interaction_parser.add_argument('--sleap-file', help = 'Defines the input SLEAP file', type = str, action = confirmFile(), required = True)
...
def main():
	...
	interactions = TrackingArray.fromSLEAP(interaction_args.sleap_file, model_yaml = interaction_args.yaml_model, threads = interaction_args.threads)
